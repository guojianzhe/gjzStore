	...
	<body>
		...
		<div class="container">
			...
			<div style="text-align: center;">
				...
				<c:if test="${pb.page>1 }">
					<li>
						<a href="${pageContext.request.contextPath }/order?method=myOrder&page=${pb.page-1 }" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
				</c:if>
					<c:forEach begin="1" end="${pb.totalPage }" var="page">
						...
						<c:if test="${pb.page!=page }">
							<li><a href="${pageContext.request.contextPath }/order?method=myOrder&page=${page }">${page }</a></li>
				...
				<c:if test="${pb.totalPage>pb.page }">
					<li>
						<a href="${pageContext.request.contextPath }/order?method=myOrder&page=${pb.page+1 }" aria-label="Next">
							<span aria-hidden="true">&raquo;</span>
						</a>
					</li>
				</c:if>
